...
/**
 * Demo security: services trust identity only when forwarded by the API gateway.
 * <p>
 * In production you'd typically use mTLS between gateway and services or validate a signed identity token.
 */
@Component
